...
\label{chap:I-1-standard-model}
  ...
  \section{Electroweak Symetry Breaking}
    ...
    \end{equation}
    is the weak mixing angle. From this transformation, it is easy to compute the compling strengths of particles to the photon field and more particularly the coupling of the positron to the photon
    \begin{equation}
      e = g_w \sin \theta_W .
    \end{equation}
  ...
  \section{Quantum Chromodynamics}
    ...
    QCD uses the $ SU(3)_C $ symetry group to describe the behaviour of quarks and gluons, and introduce the notion of colour charge. After the observation of particles composed of three identical quarks in the same spin configuration, a new quantum number had to be introduced in order to obey Pauli's exclusion principle. Through their interaction with the $ SU(3)_C $ group, quarks carry a colour: red, blue, or green. \\

    Quarks are placed in the fundamental representation of the $ SU(3)_C $ group which are triplets of the same quark with the three different colours. The convariant derivate thus becomes
    \begin{equation}
