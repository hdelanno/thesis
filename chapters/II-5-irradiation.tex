...
\label{chap:II-5-irradiation}
  ...
  \section{Data Analysis}
    ...
    \subsection{Impact for the Triple-GEM Upgrade Project}
      ...
      \begin{table}[h!]
        \begin{tabularx}{\textwidth}{C{1.2}C{1.2}C{0.8}C{0.8}}
          \textbf{Event type} & \textbf{cross section} & \textbf{Rate in CMS LHC Phase I} & \textbf{Rate in CMS LHC Phase II} \\ \hline
          SEM - recoverable & 3.08 $ \times $ 10$^{-7}$ cm$^{2}$ &  6.65 / day & 33.2 / day \\
          SEM - critical & 3.19 $ \times $ 10$^{-8}$ cm$^{2}$ & 0.68 / day & 3.44 / day \\
          BRAM - recoverable & 1.02 $ \times $ 10$^{-7}$ cm$^{2}$ & 2.19 / day & 11 / day \\
          BRAM - critical & 1.71 $ \times $ 10$^{-8}$ cm$^{2}$ & 0.27 / day & 1.33 / day \\
          CLB & 2.88 $ \times $ 10$^{-7}$ cm$^{2}$ & 6.21 / day & 31 / day \\
          DSP & 2.04 $ \times $ 10$^{-8}$ cm$^{2}$ & 0.44 / day & 2.2 / day \\
        \end{tabularx}
        \caption{Types of SEUs encountered along with their respective interaction cross section and the resulting rate of errors in CMS per FPGA assuming that the LHC runs at nominal values during 24h.}
