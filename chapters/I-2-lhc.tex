...
\label{chap:I-2-lhc}
  ...
  \section{Scientific Motivations}
    ...
    The high energy and luminosity at which the LHC operates are the key factors of its success. Reaching new energy scales enables physicists to discover new hidden sectors of nature through processes that become available during the collisions. However, due to the rarity of these events that lie beyond the standard model, it is import to accumulate a large statistics and thus run the machine at a high luminosity. \\
