...
\label{chap:II-1-gem}
  ...
  \section{GEM Upgrade Schedule}
    ...
    Finally, before installation in CMS, each component needs to be qualified and caracterized. To this end, automated procedures have been developped and are described in Chapter \ref{chap:II-5-qualification}. \\
