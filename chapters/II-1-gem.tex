...
\label{chap:II-1-gem}
  ...
  \section{Technology Overview of Triple-GEM detectors}
    ...
    \begin{figure}[t!]
      \centering
      \includegraphics[width=0.6\textwidth]{img/II-1-gem/triple-gem-foils.pdf}
  ...
  \section{GE1/1 Prototyping Results}
    ...
    \subsection{Detection Efficiency}
      ...
      \begin{figure}[t!]
        \centering
        \includegraphics[width=0.6\textwidth]{img/II-1-gem/efficiency.png}
    ...
    \subsection{Time Resolution}
      ...
      \begin{figure}[b!]
        \centering
        \includegraphics[width=0.65\textwidth]{img/II-1-gem/time-resolution.png}
