...
\label{chap:II-1-gem}
  ...
  \section{GE1/1 Prototyping Results}
    ...
    \subsection{Detection Efficiency}
      ...
      \begin{figure}[h!]
        \centering
        \includegraphics[width=0.5\textwidth]{img/II-1-gem/efficiency.png}
    ...
    \subsection{Time Resolution}
      ...
      \begin{figure}[h!]
        \centering
        \includegraphics[width=0.5\textwidth]{img/II-1-gem/time-resolution.png}
