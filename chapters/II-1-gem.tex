...
\label{chap:II-1-gem}
  ...
  \section{GEM Upgrade Schedule}
    ...
    Finally, before installation in CMS, each component needs to be qualified and characterized, and tested against the effects of radiation. To this end, automated procedures have been developed and are described in Chapters \ref{chap:II-5-qualification} and \ref{chap:II-6-irradiation}. \\
