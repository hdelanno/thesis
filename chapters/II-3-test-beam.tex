...
\label{chap:II-3-test-beam}
  ...
  \section{Data Analysis}
    ...
    \subsection{Cluster Multiplicity and Size}
      ...
      These results confirm the different behaviors between muons and pions: the former with a cluster size smaller than two, and the latter greater than two. This is due to the number of primary ionization clusters formed in the drift gap of the Triple-GEM when the particles ionize the gas. Pions form an average of 30.3 clusters cm$^{-1}$ \cite{Bamberger2007361} while muons produce 5 $\pm$ 1.3 clusters cm$^{-1}$ \cite{Blum:1105920}, both measured in ArCO$_2$. The larger number of primary clusters along the track of the particle will result in a wider spread of the electrons in the detector and thus generate a higher cluster size.
