...
\label{chap:II-3-test-beam}
  ...
  \section{Data Analysis}
    ...
    \subsection{Evolution of the Efficiency with the High-Voltage}
      ...
      The results obtained with GEM0 can be compared to the scans performed during a previous test beam \cite{Abbaneo:1709907} which used the same gas mixture. The plots show the efficiency in terms of gain, which is then expressed in terms of current. In the 700 $\mu$A to 810 $\mu$A range, gains of 100 to 8000 are obtained. Between these values, the efficiency quickly rises to 98\% to reach the very beginning of the plateau. The same behavior is observed in the results exposed before where the efficiency reaches maximum efficiency at the highest values of the high voltage right at the beginning of the plateau region. A second test beam \cite{Abbaneo:1494965} provides measurements of the efficiency as a function of the high voltage for lower thresholds of 10, 15, and 25. While they reach the efficiency plateau at lower currents, it lays at a value of 95\%, compared to 98\% for the results showed here-above.
