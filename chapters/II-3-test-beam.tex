...
\label{chap:II-3-test-beam}
  ...
  \section{The Control and Monitoring Application}
    ...
    \subsection{Hit Rate Monitoring}
      ...
      Next to DQM functionalities, the firmware also monitors the hit rate in the trigger and in tracking data forwarded by the VFAT2s. Figure \ref{fig:II-3-app-rates} is a screenshot of the page of the web application used to monitor these rates. For every connected VFAT2, the application logs the rate of hits in the trigger and tracking data, and the rate of tracking data packets that are received with a valid and corrupted CRC.
