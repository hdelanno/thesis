...
\label{chap:IV-1-acronyms}
  ...
  \begin{description}
    ...
    \item[ECC_FRAME]    \dotfille Error Checking & Correction Frame
    ...
    \item[FMC]        \dotfill FPGA Mezzanine Card
    ...
    \item[FSM]      \dotfill Finite State Machine
    ...
    \item[ICAP]         \dotfill Internal Configuration Access Port
