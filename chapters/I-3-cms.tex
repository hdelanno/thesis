...
\label{chap:I-3-cms}
  ...
  \section{The Inner Tracking System}
    ...
    \begin{figure}[t!]
      ...
      \caption{Material budget of the tracker expressed in terms of radiation length $X_0$ on the left and hadronic interaction length $\lambda_I$ on the right \cite{Chatrchyan:2014fea}.}
  ...
  \section{The Muon System}
    ...
    \subsection{Drift Tubes}
      ...
      \begin{figure}[b!]
        \centering
        \includegraphics[width=0.6\textwidth]{img/I-3-cms/dt.png}
