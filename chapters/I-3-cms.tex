...
\label{chap:I-3-cms}
  ...
  \section{The Data Acquisition System}
    ...
    %
    %   All DAQ subsystems have adopted a common software standard called Coss-Platform DAQ Framework (XDAQ). XDAQ provides standards for the applications to follow as well as a set of tools that can be used in the programs. Furthermore, it includes a signaling protocol which allows data to be transfered from application to application. \\
    %
    %   For each subdetectors, multiple applications are running to control the systems and are grouped into self-contained applications. They are grouped in the Run Control application called RCMS.
    %
