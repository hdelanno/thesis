...
\label{chap:I-3-cms}
  ...
  \section{The Data Acquisition System}
    ...
    \subsection{The Event Filter}
      ...
      The event filter role is to distribute the events to worker nodes in the processing farm which run offline reconstruction algorithms to process and select events for storange. It also

    \subsection{DAQ Software, Control, and Monitoring}

      All DAQ subsystems have adopted a common software standard called Coss-Platform DAQ Framework (XDAQ).
  ...
  \section{The Upgrades}

    Talk about Upgrades of CMS
