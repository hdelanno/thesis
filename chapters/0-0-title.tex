...
\begin{titlepage}
  \AddToShipoutPictureBG*{%
    %\AtPageUpperLeft{\raisebox{-\height}{\includegraphics[width=0.8\paperwidth]{img/0-0-title/logo.jpg}}}%
    %\AtPageLowerLeft{\includegraphics[width=0.8\paperwidth]{img/0-0-title/logo.jpg}}%
  }
