...
\label{chap:III-1-arch}
  ...
  \section{The Infrastructure of the System}
    ...
    \subsection{The Web Interface}
      ...
      \begin{figure}[p!]
        \centering
        \includegraphics[width=\textwidth]{img/III-1-arch/app-home.png}
        \includegraphics[width=\textwidth]{img/III-1-arch/app-runs.png} \\
      ...
      \begin{figure}[p!]
        \centering
        \includegraphics[width=\textwidth]{img/III-1-arch/app-hv.png}
        \includegraphics[width=\textwidth]{img/III-1-arch/app-gas.png}
